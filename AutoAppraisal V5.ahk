...
global KillTask := 0, loopamount := 2, stopallcoderunning := 0, File1 := "CordsSaveForAutoAppraisal.txt", YHalf := "", XHalf := ""
if !(fileexist(File1)) {
	SetOcrRange
	FileAppend
	(
...
thegui.Add("Text", "x" otherstarting+10 " y10 w200", "Auto Appraisal V5")
...
thegui.SetFont("s10 cwhite", "Tahoma")
uncheckallboxes := thegui.add("button", "x" otherstarting+20 " y220 w120", "Uncheck all Boxes")
uncheckallboxes.OnEvent("Click", (*) => dosomethingtoboxes(0))
checkallboxes := thegui.add("button", "x" otherstarting+20 " y190 w120", "Check all Boxes")
...
thegui.Title := "Auto Appraisal v5"
