...
global
	...
	MakeGUI()
	AppraiseAnywhereOption := thegui.Add("Checkbox", "x" otherstarting+5 " y135 +background3b3b3b w150", "Appraise Anywhere")
	...
	thegui.SetFont("s10 cwhite", "Tahoma")
	AutoUpdateMutation := thegui.add("button", "x" otherstarting+20 " y197 w125", "Update Mutation")
	AutoUpdateMutation.OnEvent("Click", (*) => UpdateMutation())
	ToggleRedBoxThing := thegui.add("button", "x" otherstarting+20 " y163 w125", "Toggle Highlight")
