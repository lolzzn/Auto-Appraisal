...
send "{``}"
sleep 300
if (Pixelsearch(&template, &template, thenofishconfirmationx-40, thenofishconfirmationy-20, thenofishconfirmationx+40, thenofishconfirmationy+20, 0xA8FF95, 1)) {
...
timeout := 0
loop {
if (pixelsearch(&template, &template, thenoclickx-40, thenoclicky-20, thenoclickx+40, thenoclicky+20, 0xD43D00, 1) and pixelsearch(&template, &template, theyesclickx-40, theyesclicky-20, theyesclickx+40, theyesclicky+20, 0xA8FF95, 1)) {
break
}
if (timeout >= 100) {
break
...
global
	...
	thegui.Add("Text", "x" otherstarting+10 " y10 w200", "Auto Appraisal V7")
	...
	thegui.Title := "Auto Appraisal v7"
